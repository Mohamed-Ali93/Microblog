...
namespace Microblog.Migrations
{
    ...
    [Migration("20250304143245_AddPosts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microblog.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microblog.Posts.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsImageProcessed")
            ...
            modelBuilder.Entity("Microblog.Posts.ProcessedImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microblog.Posts.Post", b =>
                {
                    b.OwnsOne("Microblog.Posts.GeoCoordinate", "Location", b1 =>
                        {
            ...
            modelBuilder.Entity("Microblog.Posts.ProcessedImage", b =>
                {
                    b.HasOne("Microblog.Posts.Post", null)
